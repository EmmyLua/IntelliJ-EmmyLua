...
public class LuaClassFieldIndex extends StringStubIndexExtension<LuaClassField> {
    ...
    public static Collection<LuaClassField> find(@NotNull String className, @NotNull String fieldName, @NotNull SearchContext context) {
        ...
        if (classDef != null) {
            ITyClass type = classDef.getClassType();
    ...
    @Nullable
    public static LuaClassField find(ITyClass type, String fieldName, SearchContext context) {
    ...
    @NotNull
    public static Collection<LuaClassField> findAll(ITyClass type, String fieldName, SearchContext context) {
