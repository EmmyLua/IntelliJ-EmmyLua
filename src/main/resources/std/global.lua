...
--- that amount of memory (in KBytes) had been allocated by Lua. Returns **true**
...
---
--- A global variable (not a function) that holds the global environment (see §2
--- .2). Lua itself does not use this variable; changing its value does not 
...
---@overload fun(chunk:fun():string):void
